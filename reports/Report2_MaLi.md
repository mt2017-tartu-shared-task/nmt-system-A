...
5. (1)Incorrect words, incorrect form: plural form instead of singular for description (2) Incorrect words, incorrect form: that fit instead of that fits as.result of plural form
...
4. *the Anticons are spontaneously transformed into the catheonns, but there is.lot less frequent.*
